...
import ActiveSessionMode from '../../components/activeSessionMode';
import BackToTablesButton from '../../components/backToTablesButton';
import type { PracticeFlow } from '../../models/practiceFlow';

vi.mock('../../components/backToTablesButton', () => ({

...
const useActiveSessionViewModel = (session: PracticeFlowType): ActiveSessionViewModel => ({
  ...
  multiplier: session.kind === 'currentQuestion' ? session.currentQuestion.multiplier : 1,

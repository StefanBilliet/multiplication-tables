...
The `staticwebapp.config.json` is applied automatically by the GitHub Actions deploy step. If you need to apply it manually, use the Azure Portal or re-run the workflow.
